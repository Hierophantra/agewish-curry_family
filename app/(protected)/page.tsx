...
import FamilySearch from '@/components/home/FamilySearch'
    ...
    <>
      ...
      <section className="relative bg-gradient-to-b from-ivory via-ivory to-ivory-deep border-t border-stone/60 py-20 md:py-28 px-7 md:px-11">
        <div className="max-w-7xl mx-auto">
          {/* Find a family member - search that jumps to a profile. */}
          <div className="mb-14">
            <FamilySearch people={people.map((p) => ({ id: p.id, name: p.name, relationLabel: p.relationLabel }))} />
          </div>
