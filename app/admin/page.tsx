...
const sections = [
  ...
  { href: '/admin/communications', label: 'Communications', desc: 'Email/text announcements to family members (compose + preview; sending not yet connected)', status: 'live' },
  { href: '/admin/screens', label: 'Sections', desc: 'Show or hide whole sections (featured film, slideshow link)', status: 'live' },
