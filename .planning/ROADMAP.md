...
- [ ] **Phase 1: Scaffold + Auth Gate + Design System** - Secure foundation, design tokens, content loader contract, and home page
...
|-------|----------------|--------|-----------|
| 1. Scaffold + Auth Gate + Design System | 0/TBD | Not started | - |
